...
public class BookController {
    static final Book[] books = {
            ...
            new Book(2,"红楼梦","曹雪芹","人民文学出版社",0, 20.0, "/images/hlm.jpg", "《红楼梦》是中国古典四大名著之一，是中国古典文学的杰出代表作，也是中国现代文学的开山之作。"),
            new Book(3,"三国演义","罗贯中","人民文学出版社",5, 20.0, "/images/sgyy.jpg", "《三国演义》是中国古典四大名著之一，是中国古典文学的杰出代表作，也是中国现代文学的开山之作。"),
